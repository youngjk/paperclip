 ...
 *
 * connector.connection_created / connector.connection_updated /
...
export const EVENT_RETENTION_CLASS: Partial<Record<string, RetentionClass>> = {
  ...
  "connector.connection_created": "operational_enum_count",
  "connector.connection_updated": "operational_enum_count",
  "connector.invocation_completed": "operational_enum_count",
};
